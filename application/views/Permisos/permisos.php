      ...
      <div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<br>
				<br>
				<a class="custom-btn btn-14" href="<?=base_url().'PermisosController/nuevoPermiso';?>">
					...
					<tbody>
						<?php foreach ($menu as $m): ?>
							<tr>
								...
								<td><?=$m->ELIMINAR;?></td>
								<td>
									<a href="<?php echo base_url().'PermisosController/editarPermiso/'.$m->ID_MENU; ?>" class="btn btn-primary">
										<i class="bi bi-pencil-square"></i>
									</a>
									<a href="<?php echo base_url().'PermisosController/deletePermiso/'.$m->ID_MENU; ?>" class="btn btn-danger">
